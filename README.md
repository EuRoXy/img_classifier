...
- [Microsoft ResNet-50](https://huggingface.co/microsoft/resnet-50)
    ...
    - Architecture: A deep Residual Network with 50 layers that uses skip connections to prevent vanishing gradients, making it highly effective for image classification
    - Predictions: Also trained on ImageNet-1k with 1,000 categories, providing confidence scores and top-k predictions for comprehensive analysis